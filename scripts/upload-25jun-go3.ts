/**
 * 25년 6월 고3 영어모의고사 조건영작배열 일괄 업로드.
 *
 * 사용법:
 *   npx tsx scripts/upload-25jun-go3.ts            # dry-run
 *   npx tsx scripts/upload-25jun-go3.ts --apply    # 실제 업로드
 */
...
const NUM_DIR = "/Users/goshua/payperic/.upload-staging/25jun-go3/by-number"
const DIFF_DIR = "/Users/goshua/payperic/.upload-staging/25jun-go3/by-difficulty"

const PREFIX = "25년 6월 고3 영어모의고사"
const BASE_TAGS = ["고3", "25년 6월", "조건영작배열"] as const
...
async function main() {
  ...
  console.log(`\n=== 25년 6월 고3 조건영작배열 업로드 ${APPLY ? "[APPLY]" : "[DRY-RUN]"} ===\n`)

/**
 * 26년 3월 고3 영어모의고사 조건영작배열 일괄 업로드.
 *
 * 사용법:
 *   npx tsx scripts/upload-26mar-go3.ts            # dry-run
 *   npx tsx scripts/upload-26mar-go3.ts --apply    # 실제 업로드
 */
...
const NUM_DIR = "/Users/goshua/Downloads/26년 3월 고3 영어모의고사_번호별"
const DIFF_DIR = "/Users/goshua/Downloads/26년 3월 고3 영어모의고사_난도별"

const PREFIX = "26년 3월 고3 영어모의고사"
const BASE_TAGS = ["고3", "26년 3월", "조건영작배열"] as const
...
async function main() {
  ...
  console.log(`\n=== 26년 3월 고3 조건영작배열 업로드 ${APPLY ? "[APPLY]" : "[DRY-RUN]"} ===\n`)

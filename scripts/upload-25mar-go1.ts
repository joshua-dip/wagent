/**
 * 25년 3월 고1 영어모의고사 조건영작배열 일괄 업로드.
 *
 * 사용법:
 *   npx tsx scripts/upload-25mar-go1.ts            # dry-run
 *   npx tsx scripts/upload-25mar-go1.ts --apply    # 실제 업로드
 */
...
const NUM_DIR = "/Users/goshua/payperic/.upload-staging/25mar-go1/by-number"
const DIFF_DIR = "/Users/goshua/payperic/.upload-staging/25mar-go1/by-difficulty"

const PREFIX = "25년 3월 고1 영어모의고사"
const BASE_TAGS = ["고1", "25년 3월", "조건영작배열"] as const
...
async function main() {
  ...
  console.log(`\n=== 25년 3월 고1 조건영작배열 업로드 ${APPLY ? "[APPLY]" : "[DRY-RUN]"} ===\n`)

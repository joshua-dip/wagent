...
export default function EBSSpecialEnglishPage() {
  ...
  const categories = [
    ...
    { id: "textbook", name: "교재 전체", count: 0 },
    { id: "chapter-materials", name: "단원별 자료", count: 0 },
    { id: "test-materials", name: "평가 자료", count: 0 },
    { id: "answer-sheets", name: "정답지", count: 0 }
  ]
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.ok) {
        // EBS수능특강영어 관련 카테고리만 필터링
        const ebsCategories = [
          'textbook', 'chapter-materials', 'test-materials', 'answer-sheets'
        ]
        
        const filteredProducts = data.products.filter((product: any) => 
          ebsCategories.includes(product.category) ||
          product.title?.includes('EBS') ||
          product.title?.includes('수능특강')
        )
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-12">
        <div className="px-6 sm:px-8 lg:px-12">
          <div className="flex items-center mb-4">
            ...
            <h1 className="text-3xl font-bold">EBS 수능특강 영어</h1>
          </div>
          <p className="text-xl text-blue-100 mb-6">
            2025학년도 EBS 수능특강 영어 완벽 대비 자료
          </p>
